...
// private final double turretOffset = 300;
  ...
  public SmartShootCopy(ShooterSub l_shooterSub, TurretSub l_turretSub, IntakeSub l_intakeSub, GenericHID l_buttonBox, CommandXboxController l_driverController) {
