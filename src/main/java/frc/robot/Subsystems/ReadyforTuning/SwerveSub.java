...
//Swerve Subsystem contains all drivetrain, gyro, and pathplanner
public class SwerveSub extends SubsystemBase {
  /** Creates a new SwerveSubsystem. */

  //allows swerve to read json files
File directory = new File(Filesystem.getDeployDirectory(),"2025BotJson"); //CHANGE STRING TO MATCH FOLDER NAME
    ...
    try
    {
      ...
      AutoBuilder.configure(
          ...
          new PPHolonomicDriveController(
              ...
              new PIDConstants(1.0, 0.0, 0.0), //FOR TUNING AUTO ONLY AUDJUST JSON FILES FIRST!!!!
              // Translation PID constants
              new PIDConstants(0.1, 0.0, 0.0) //used to be .5
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  public Command driveWithSetpointGeneratorFieldRelative(Supplier<ChassisSpeeds> fieldRelativeSpeeds)
  {
   ...
   //////////////////////////////////////////////////////////////////////////////////////////////////
//anything here is methods used for the pathplanner
...
// public Command getAutonomousCommandSub(String pathName) { 
