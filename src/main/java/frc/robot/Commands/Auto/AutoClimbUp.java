...
// private final double turretOffset = 300;
  ...
  public AutoClimbUp(ClimberSub l_climberSub, SwerveSub l_driveBase) {
  ...
  public boolean isFinished() {
    return climberSub.getClimberPosition() > 205; //if doesent work may need to invert return value
  }
}
