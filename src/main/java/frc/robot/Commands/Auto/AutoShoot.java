...
// private final double turretOffset = 300;
  ...
  public AutoShoot(ShooterSub l_shooterSub, TurretSub l_turretSub, IntakeSub l_intakeSub, GenericHID l_buttonBox) {
  ...
  public boolean isFinished() {
    return turretSub.getFlywheelPosition() > 10000; //if doesent work may need to invert return value
  }
}
