...
// private final double turretOffset = 300;
  ...
  public StaticShoot(ShooterSub l_shooterSub, TurretSub l_turretSub, IntakeSub l_intakeSub, GenericHID l_buttonBox) {
...
double targetRPM = rpmEntry.getDouble(3000);
  ...
  public boolean isFinished() {
    return !buttonBox.getRawButton(4); //buttonBox.getRawButtonReleased(5)
